...
import { ProblemParams, problemsParams } from "../params";

interface Props {
    placeholder?: string;
    params: ProblemParams; 
    setParams: (params: Partial<ProblemParams>) => void;
}
...
export const SearchInput = ({
    ...
    return (
        <div className="relative ml-auto">
            <HugeiconsIcon icon={Search01FreeIcons} strokeWidth={2} className="size-3.5 absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground" />
            <Input
